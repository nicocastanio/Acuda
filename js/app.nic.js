    ...
    window.plugin.email.isServiceAvailable(
        function (isAvailable) {
            window.plugin.email.open({
                to:      ['horaciofigueroa@maweseguridad.com.ar'] ,   
...
var envioConPHP = function(smsBody) {
    ...
    $.ajax({
        ...
        data: 'body='+smsBody+'&email='+extData['to']['2'],
...
$(document).ready( function() {
    ...
    $.getJSON("http://www.presmia.com/app/get_json_data.php", function(dataJ){
        ...
        */
        //console.log(dataJ['to']['1']);
        extData = dataJ; 
    });
    
    
    onDeviceReady();  // quitarlo para la version mobile. se usa para version browser.
